...
class KVCacheEstimator:
    ...
    def from_request(
        ...
        *,
        ...
        # spec-decode aware (e.g. for any draft-module weights). Mirrors the
        # agg/disagg/static estimate paths in cli.api.
        ...
        # modeled, a small, conservative approximation vs. the gross prior over-count.
